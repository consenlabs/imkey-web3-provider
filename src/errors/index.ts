...
export const imkeyAPIError = createCustomErrorClass("imkeyAPIError");
export const imkeyAPIErrorWithMessage = createCustomErrorClass(
  "imkeyAPIErrorWithMessage"
);
export const imkeyAPINotAvailable = createCustomErrorClass(
  "imkeyAPINotAvailable"
);
...
export const imkeyAPI4xx = createCustomErrorClass("imkeyAPI4xx");
export const imkeyAPI5xx = createCustomErrorClass("imkeyAPI5xx");
