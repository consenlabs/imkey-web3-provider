 ...
 */
export function RecordStoreWrongAPDU(this: any, expected: string, got: string, line: number) {
...
export class RecordStore {
   ...
   */
  static fromString(str: string, opts?: $Shape<RecordStoreOptions>): RecordStore {
    const queue: Queue = []
    let value = []
    str
      .split('\n')
